...
import com.profileing.AnomalyEventDetect;
...
public class AnomalyDetectionView extends JInternalFrame implements InternalFrameListener {
	...
	public AnomalyDetectionView() {
		super("Front view Anomaly Detection Window");
		initialize();
		setColor();
	...
	private void initialize() {
		...
		this.setTitle("Front view Anomaly Detection Window");
...
public static void setSplitImage(Image image){
	...
	public void internalFrameClosing(InternalFrameEvent e) {
		// TODO Auto-generated method stub
		ShowProcess.jMenuItemAnomalyDetection.setEnabled(true);
	}
