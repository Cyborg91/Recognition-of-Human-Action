...
import anomaly.com.profileing.AnomalyEventDetect;
//import anomaly.com.profileing.TrainEventDetection;

/**
 * @author Owner
 *
 */
public class AnomalyDetectionView extends JInternalFrame implements InternalFrameListener {

	/**
	 * 
	 */
	private static final long serialVersionUID = 2689837811399796490L;
	...
	private AnomalyEventDetect anomalyEventDetect = null;
	...
	public static JTextField jTextFieldExistBlobName = null;
	
	/**
	 * This is the default constructor
	 */
	public AnomalyDetectionView() {
		super("Anomaly Detection Window");
		initialize();
		setColor();
	...
	private void initialize() {
		this.setSize(904, 504);
		this.setTitle("Top view Anomaly Detection Window");
	...
	private JPanel getJContentPane() {
		if (jContentPane == null) {
			jLabel4 = new JLabel();
			jLabel4.setBounds(new java.awt.Rectangle(19,415,173,16));
			jLabel4.setText("Compare With Exist Event :");
			jLabel3 = new JLabel();
			...
			jContentPane.add(getJTextFieldExistBlobName(), null);
		}
		return jContentPane;
	}
	...
	private JButton getJButtonStartDetect() {
		if (jButtonStartDetect == null) {
			...
			jButtonStartDetect.setText("Start Detection");
			jButtonStartDetect.addActionListener(new java.awt.event.ActionListener() {
				public void actionPerformed(java.awt.event.ActionEvent e) {
					...
					if(filename == null || filename.equals("") || !filename.endsWith("avi")){
						...
						anomalyEventDetect = new AnomalyEventDetect();
						anomalyEventDetect.eventCapturing(filename);
						AnomalyDetectionView.jButtonStartDetect.setEnabled(false);
					}
				}
			});
		}
...
public static void setSplitImage(Image image){
	...
	public void internalFrameClosing(InternalFrameEvent e) {
		// TODO Auto-generated method stub
		ShowProcess1.jMenuItemAnomalyDetection.setEnabled(true);
	}
	...
	/**
	 * This method initializes jTextFieldExistBlobName	
	 * 	
	 * @return javax.swing.JTextField	
	 */
	private JTextField getJTextFieldExistBlobName() {
		if (jTextFieldExistBlobName == null) {
			jTextFieldExistBlobName = new JTextField();
			jTextFieldExistBlobName.setBounds(new java.awt.Rectangle(207,413,444,19));
		}
		return jTextFieldExistBlobName;
	}
