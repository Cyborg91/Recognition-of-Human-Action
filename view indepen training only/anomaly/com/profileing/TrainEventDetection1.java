...
public class TrainEventDetection1 implements Runnable{
...
//			ShowProcess.println(" C("+y1+","+xOfy1+")"+" D("+y2+","+xOfy2+")" );
			...
			eventChecking1(event1);
			
			/*if(i==60)
			 break;	*/		
				TrainingView.setSplitImage1(tmpImage);
		}//end of i loop
...
//		thread.stop();
		...
		JOptionPane.showMessageDialog(null,"Top view Trainig Finished");
		//TrainingView.jButtonStartDetect1.setEnabled(true);
...
*/
	...
	public void eventCapturing1(String path,boolean append){
	...
	private void eventChecking1(Event e){
		Event e1;
		boolean flag=false;
		...
		if(!flag){
			vector.add(e);
			differentFrames++;
			TrainingView.jPanelDetectionShow1.setBackground(java.awt.Color.red);
			//if(TrainingView.jCheckBoxVoiceEffect.isSelected())
...
//		ShowProcess.println();
		...
		TrainingView.setBlobImage1(img1);
...
//		param.setQuality((float)((double)75 / 100D), true);
	...
	public static void main(String args[]){
		TrainEventDetection1 ed = new TrainEventDetection1();
		ed.eventCapturing1("E:/premkumar/record_anamoly/Video/palanitr1.avi",true);
	}
}
